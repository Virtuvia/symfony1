...
class sfImage
{
    ...
    */
    ...
    {
        $defaults = sfConfig::get('app_sfImageTransformPlugin_default_image', ['filename' => 'Untitled.png', 'mime_type' => 'image/png', 'width' => 100, 'height' => 100]);
     ...
     * @param int Valid range is from 0 (worst) to 100 (best)
     *
     */
    ...
    protected function autoDetectMIMETypeFromFile($filename)
    {
        ...
        $support_libraries = ['fileinfo', 'mime_type', 'gd_mime_type'];
