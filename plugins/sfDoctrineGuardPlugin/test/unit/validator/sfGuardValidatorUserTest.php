...
{
    public $active   = true;
    public $username = 'mock';
    public $emailAddress = 'mock@example.com';
    public $password = 'correct';
...
try {
    $values = $validator->clean(['username' => 'mock', 'password' => 'correct']);
...
try {
    $values = $validator->clean(['username' => 'mock@example.com', 'password' => 'correct']);
...
try {
    $validator->clean(['username' => 'mock', 'password' => 'incorrect']);
...
try {
    $validator->clean(['username' => null, 'password' => null]);
