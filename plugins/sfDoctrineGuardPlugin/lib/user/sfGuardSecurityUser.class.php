...
class sfGuardSecurityUser extends sfBasicSecurityUser
{
    ...
    {
        return $this->getGuardUser() ? $this->getGuardUser()->getGroups() : [];
    }
    ...
    {
        return $this->getGuardUser() ? $this->getGuardUser()->getGroupNames() : [];
    }
    ...
    {
        return $this->getGuardUser() ? $this->getGuardUser()->getPermissionNames() : [];
    }
    ...
    {
        return $this->getGuardUser() ? $this->getGuardUser()->getAllPermissions() : [];
    }
    ...
    {
        return $this->getGuardUser() ? $this->getGuardUser()->getAllPermissionNames() : [];
    }
