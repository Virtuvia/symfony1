CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT, author_id INTEGER, is_on_homepage INTEGER, title VARCHAR(255) UNIQUE, body VARCHAR(255), test_column VARCHAR(255), views INTEGER, type VARCHAR(255), slug VARCHAR(255), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL);
...
CREATE TABLE form_generator_test3 (id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(255));
...
CREATE UNIQUE INDEX article_sluggable_idx ON article (slug, title);
