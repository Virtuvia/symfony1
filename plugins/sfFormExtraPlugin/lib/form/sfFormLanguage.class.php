...
class sfFormLanguage extends sfForm
{
     ...
     * @see sfForm
     */
    public function __construct(sfUser $user, $options = [], $CSRFSecret = null)
    {
        $this->user = $user;
        ...
        parent::__construct(['language' => $user->getCulture()], $options, $CSRFSecret);
    }
    ...
    {
        $data = ['language' => $request->getParameter('language')];
    ...
    {
        $this->setValidators([
            'language' => new sfValidatorI18nChoiceLanguage(['languages' => $this->options['languages']]),
        ]);

        $this->setWidgets([
            'language' => new sfWidgetFormI18nChoiceLanguage(['culture' => $this->user->getCulture(), 'languages' => $this->options['languages']]),
        ]);
    }
}
