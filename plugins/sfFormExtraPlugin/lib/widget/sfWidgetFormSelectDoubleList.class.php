...
EOF
    ...
    public function render($name, $value = null, $attributes = [], $errors = [])
    {
        ...
        $associatedWidget = new sfWidgetFormSelect(['multiple' => true, 'choices' => $associated], ['size' => $size, 'class' => $this->getOption('class_select') . '-selected']);
        $associatedWidget->setParent($this->getParent());

        $unassociatedWidget = new sfWidgetFormSelect(['multiple' => true, 'choices' => $unassociated], ['size' => $size, 'class' => $this->getOption('class_select')]);
    ...
    {
        return ['/sfFormExtraPlugin/js/double_list.js'];
    }
