...
abstract class sfRequest implements ArrayAccess
{
    ...
    {
        if (!in_array(strtoupper($method), [self::GET, self::POST, self::PUT, self::DELETE, self::HEAD, self::OPTIONS])) {
     ...
     *
     * @param  mixed $offset The name of the request parameter
     *
     ...
     *
     * @return string|bool The content or false if none is available
     */
