...
$t->is(stylesheet_tag('style', ['media' => 'all']),
    '<link rel="stylesheet" type="text/css" media="all" href="/css/style.css" />' . "\n",
    'stylesheet_tag() can take a media option');
$t->is(stylesheet_tag('style', ['absolute' => true]),
...
$t->is(stylesheet_tag('style', ['raw_name' => true]),
...
$t->is(stylesheet_tag('style', ['condition' => 'IE 6']),
...
$t->is(javascript_include_tag('xmlhr', ['absolute' => true]),
...
$t->is(javascript_include_tag('xmlhr', ['raw_name' => true]),
...
$t->is(javascript_include_tag('xmlhr', ['defer' => 'defer']),
...
$t->is(javascript_include_tag('xmlhr', ['condition' => 'IE 6']),
