...
$t->is($e->getErrors(), ['e1' => $e1, 'e2' => $e2], '__construct() can take an array of sfValidatorError as its second argument');
...
$es1 = new sfValidatorErrorSchema($v1, [$e1, 'e1' => $e1, 'e2' => $e2]);
$es = new sfValidatorErrorSchema($v1, [$e1, 'e1' => $e1, 'e2' => $es1]);
$es->addError($e2, 'e1');
...
$es = new sfValidatorErrorSchema($v1, [$e1, 'e1' => $e1, 'e2' => $es1]);
$es2 = new sfValidatorErrorSchema($v1, [$e1, 'e1' => $e1, 'e2' => $es1]);
$es->addError($es2, 'e2');
...
$t->is($es->getNamedErrors(), ['1' => $e2], '->addErrors() merges a sfValidatorErrorSchema to the current error');
...
$e = new sfValidatorErrorSchema($v1, ['e1' => $e1, $e2]);
$e->addError($e2, '2');
$errors = [];
...
$t->is($e1->getCodeString(), $e->getCodeString(), 'sfValidatorErrorSchema is serializable');
