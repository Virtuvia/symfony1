...
$v1 = new sfValidatorString(['min_length' => 3]);

// __construct()
$t->diag('__construct()');
$v = new sfValidatorSchemaForEach($v1, 3);
$t->is($v->getFields(), [$v1, $v1, $v1], '->__construct() takes a sfValidator object as its first argument');

$v = new sfValidatorSchemaForEach($v1, 6);
$t->is($v->getFields(), [$v1, $v1, $v1, $v1, $v1, $v1], '->__construct() takes a number of times to duplicate the validator');
